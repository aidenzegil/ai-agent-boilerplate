...
rl.question(
  ...
  (providerName: string) => {
    ...
    const pathToProviderDirectory = `src/app/providers/${input}Provider`;
    fs.mkdirSync(pathToProviderDirectory);
    console.log("Generating types...");
    fs.writeFileSync(
      `${pathToProviderDirectory}/types.ts`,
      `
import { ${inputAsType}DTO } from "@/app/network/types/outputDtos"
...
export type ${inputAsType}ProviderFunctions = {
  ...
  `
    ...
    fs.writeFileSync(
      ...
      `
import { ${input}Controller } from "@/app/lib/server/controllers/${input}/controller";
import { params } from "@/app/lib/server/controllers/${input}/params";
